                ...
                <form:form action="/products/new" method="post" modelAttribute="product">
                        <div class="form-row p-1">
                            ...
                            <div class="col col-3">
                                ...
                                <form:input class="form-control shadow" path="name" />
                            </div>
                        </div>
                        <div class="form-row p-1">
                            <div class="col col-2 h4">
                            ...
                            <div class="col col-3">
                                ...
                                <form:input path="description" class="form-control shadow"></form:input>
                        </div>
                        </div>
                        <div class="form-row p1-4 pl-1">
                            <div class="col col-2 h4">
                                <form:label path="price" class="col-form-label">Price:</form:label>
                            </div>
                            <div class="col col-1">
                                <form:errors path="price" class="text-danger" />
                                <form:input path="price" class="form-control shadow" type="number"/>
                            </div>
                        </div>
