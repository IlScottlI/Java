...
public class CounterApplication {
	...
	@RequestMapping("/")
	public String index(HttpSession sessionStorage) {
		int counter = 0;
	...
	public String counter(HttpSession session) {
		...
		return "<div style='display:flex'><h1 style='margin-top:4rem;'>You have visited <a href='http://localhost:8080/'>http://localhost:8080/</a> "
				+ count + " times</h1></div>"
