            ...
            <nav class="navbar navbar-light navbar-expand-md navigation-clean">
                <div class="container">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link">Songs by artist: ${term}</a></li>
                        <li class="nav-item"></li>
                        <li class="nav-item text-secondary"><i class="fa fa-search p-2 pt-3"></i></li>
                    </ul>
                    <form class="form-inline" method="post" action="/search">
                        <input class="form-control form-control-sm" type="search" name="term" value="${term}">
                    ...
                    <div class="collapse navbar-collapse d-xl-flex justify-content-xl-end" id="navcol-1">
                        <ul class="navbar-nav float-right">
                            <li class="nav-item"><a class="navbar-brand text-primary" href="/dashboard">Dashboard</a>
                            </li>
                        </ul>
                    </div>
                </div>
