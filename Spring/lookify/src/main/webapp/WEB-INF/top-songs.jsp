...
<body>
    ...
    <section class="register-photo">
        <div class="row justify-content-center align-items-center p-4">
            ...
            <div class="col-xl-3 text-right align-self-end"><a class="btn btn-outline-primary text-right" role="button" href="dashboard.html">Dashboard</a></div>
        </div>
        <div class="form-container bg-light-gray">
            <form class="shadow-sm" method="post">
                <ul class="list-unstyled">
                    <li>9 -&nbsp;<a href="#">Castle on the hill</a>&nbsp;- Ed</li>
                </ul>
            </form>
        </div>
    </section>
